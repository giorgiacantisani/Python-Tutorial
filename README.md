...
6. Activate the virtualenv
 ...
 7. 
    1. Install the basic dependencies of cookiecutter (if you want). Notice that doing so also you will install the src 
    ...
    ```
   2. I can also inatall the src package as editable
